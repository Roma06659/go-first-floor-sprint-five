...
func (r Running) Calories() float64 {
	return ((CaloriesMeanSpeedMultiplier*r.Training.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours)
}
...
func (w Walking) Calories() float64 {
	return (CaloriesWeightMultiplier*w.Training.Weight + ((math.Pow(w.Training.meanSpeed(), 2)/KmHInMsec)/w.Height)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours
}
